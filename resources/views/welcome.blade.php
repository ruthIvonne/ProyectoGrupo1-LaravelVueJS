    ...
    <header data-bs-theme="dark">
      <<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <div class="container-fluid">
          <a class="navbar-brand" href="#">Venta de Cursos</a>
  ...
  <div class="container marketing">
    ...
    <div class="row">
      <div class="col-lg-4">
        ...
        <h2 class="fw-normal">Steve Jobs</h2>
        <p>Conoce los cursos del creador Steve Jobs!</p>
        <p><a class="btn btn-secondary" href="#">ver más detalles &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
        <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="var(--bs-secondary-color)"/></svg>
        <h2 class="fw-normal">Richard Feymann</h2>
        <p>Estas ante el mejor profesor de física de la historia! conoce sus cursos</p>
        <p><a class="btn btn-secondary" href="#">Ver más detalles &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
        <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="var(--bs-secondary-color)"/></svg>
        <h2 class="fw-normal">el RichMC</h2>
        <p>No existe un mejor jugador de Minecraft</p>
        <p><a class="btn btn-secondary" href="#">Ver más detalles &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
    </div><!-- /.row -->
    ...
    <div class="row featurette">
      <div class="col-md-7">
        <h2 class="featurette-heading fw-normal lh-1">Curso de Laravel y VueJS <span class="text-body-secondary">¡Aprende a programar!</span></h2>
        <p class="lead">Este curso es genial! (agreguemos más detalles) </p>
      </div>
      <div class="col-md-5">
    ...
    <div class="row featurette">
      <div class="col-md-7 order-md-2">
        <h2 class="featurette-heading fw-normal lh-1">Curso de Mecanica Cuántica</h2>
        <p class="lead">te atreves a un verdadero desafío?</p>
      </div>
    ...
    <div class="row featurette">
      <div class="col-md-7">
        <h2 class="featurette-heading fw-normal lh-1">Curso de Minecraft</h2>
        <p class="lead">Aprende minecraft técnico con el mejor jugador</p>
      </div>
      <div class="col-md-5">
        <svg class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="var(--bs-secondary-bg)"/><text x="50%" y="50%" fill="var(--bs-secondary-color)" dy=".3em">500x500</text></svg>
      </div>
